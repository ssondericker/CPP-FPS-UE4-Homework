...
AFPSCharacter::AFPSCharacter()
{
	...
	// Attach the FPSMesh to the FPS camera
	...
	// The owning player doesn't get to see the regular body mesh
...
void AFPSCharacter::Fire()
{
	...
	if (ProjectileClass)
	{
		...
		//set MussleOffset to spawn projectiles slightly in front of the camera
